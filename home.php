...
$patients_email = $_SESSION['patients_email'];
$patients_password = $_SESSION['patients_password'];
...
$row_patients = mysqli_fetch_row($results_patients);
     $patients_id = $row_patients[0];
    $patients_firstName = $row_patients[1];
    $patients_lastName = $row_patients[2];
    $patients_phnNumber = $row_patients[6];

$sql_prescription = "SELECT * from prescription where patients_id='" . $patients_id . "'  ";
$results_prescription = mysqli_query($conn, $sql_patients);
$row_prescription = mysqli_fetch_row($results_patients);
            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
						...
						<li><a href="prescriptionTable.php?patients_id=<?php echo $patients_id; ?>">Prescription</a></li>
                       
                        
                        <li><a href="patients_profile"><?php echo "Hi, ".$patients_firstName; ?></a></li>
