            ...
            <div class="container">
                ...
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="SignIn_Signup/sign_in.php">Sign In</a></li>
                        <li><a href="SignIn_Signup/sign_up.php">Join</a></li>
                    </ul>
                </div>
            </div>
        </div>
	</header>
	<!-- end header Start Modal -->
<!-- 
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Birth Regestration Details</h4>
                    </div>
   ...
   <script>
            $(document).ready(function () {
                $('#insert_form').on("submit", function (event) {
                    ...
                    if ($('#father_name').val() == null || $('#mother_name').val() == null)
                    {
